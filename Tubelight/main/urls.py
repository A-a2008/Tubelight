...
urlpatterns = [
    ...
    path("tubes/connections/<int:template_id>/<int:event_id>/", views.display_subevents, name="display_subevents"),
    ...
    path("services/edit_service/<int:service_id>/", views.edit_service, name="edit_service"),
]